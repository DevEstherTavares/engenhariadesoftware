...
- [14. Considerações sobre segurança](#14-considerações-sobre-segurança)
  - [14.1. Considerações do lado do cliente](#141-considerações-do-lado-do-cliente)
  - [14.2. Considerações do lado do servidor](#142-considerações-do-lado-do-servidor)
- [15. Manutenção, instalação e Novas funcionalidades](#15-manutenção-instalação-e-novas-funcionalidades)
  ...
  - [15.3. Planos de contingência](#153-planos-de-contingência)
  - [15.4. Procedimentos Pós-Instalação](#154-procedimentos-pós-instalação)
  - [15.5. Monitoramento Lado Cliente e Servidor](#155-monitoramento-lado-cliente-e-servidor)
  - [15.6. Critérios de Backup e Restore](#156-critérios-de-backup-e-restore)
  - [15.7. Suporte ao Usuário e Critérios de Atendimento](#157-suporte-ao-usuário-e-critérios-de-atendimento)
- [16. Treinamento](#16-treinamento)
  - [16.1. Treinamento para Usuários (Clientes e Veterinários)](#161-treinamento-para-usuários-clientes-e-veterinários)
  - [16.2. Treinamento para Administradores](#162-treinamento-para-administradores)
...
[Voltar ao Início](#repositório-de-eng-de-software)
## 2.1. Requisitos
